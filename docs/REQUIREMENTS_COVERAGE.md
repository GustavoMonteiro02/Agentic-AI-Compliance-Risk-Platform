...
- Human review queue, approve/reject/request-more-evidence actions, reviewer notes, risk override validation, review history, and SLA/critical-gap escalation signals.
